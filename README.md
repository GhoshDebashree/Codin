# :rocket: Data structures and Algorithms
...
| 6 | Find the smallest element in ana array | [Find the smallest in method 1 with time complexity O(N^2)](Arrays/TestPrimeNumbers/Arrays/CheckMinimumOne.java)| [Find the smallest in method 1 with time complexity O(N)](Arrays/TestPrimeNumbers/Arrays/CheckMinimumTwo.java)| |